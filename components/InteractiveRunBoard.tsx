...
const tiles:Tile[]=[
 ...
 {label:"한강공원",icon:"🌳",href:"/explore?q=한강",hint:"한강과 수변 코스를 추천해요.",tone:"green"},
 {label:"자유 러닝",icon:"🏃",href:"/run/free",hint:"코스 없이 바로 개인 기록을 시작해요.",tone:"blue"},
 {label:"카페",icon:"☕",href:"/explore?q=카페",hint:"러닝 후 카페까지 이어보세요.",tone:"yellow"},
 {label:"GPS 아트",icon:"🎨",href:"/explore?type=art",hint:"달리며 그림을 완성하는 코스예요.",tone:"orange"},
 {label:"CHANCE",icon:"🎲",href:"/explore",hint:"새로운 코스를 만나보세요.",tone:"pink"},
 {label:"맛집",icon:"🍴",href:"/explore?q=RUN+EAT",hint:"RUN + EAT 코스를 확인해요.",tone:"red"},
 {label:"숲길",icon:"🌲",href:"/explore?q=숲길",hint:"공원·숲길 코스를 찾아보세요.",tone:"green"},
 {label:"야간",icon:"🌙",href:"/explore?night=1",hint:"야간 추천 코스를 찾아보세요.",tone:"purple"},
 ...
 {label:"공원",icon:"🌿",href:"/explore?q=공원",hint:"공원 러닝 코스를 찾아보세요.",tone:"green"},
 {label:"트랙런",icon:"🏟️",href:"/run/track",hint:"400m 자동랩과 랩 페이스로 트랙 훈련을 기록해요.",tone:"yellow"},
 {label:"둘레길",icon:"⛰️",href:"/explore?q=둘레길",hint:"둘레길 코스를 찾아보세요.",tone:"earth"},
 {label:"랜드마크",icon:"🗼",href:"/explore?q=랜드마크",hint:"도시를 여행하듯 달리는 코스예요.",tone:"purple"},
 {label:"CHANCE",icon:"❓",href:"/explore",hint:"한 번 더 굴려 새로운 코스를 만나보세요.",tone:"pink"},
 {label:"산책길",icon:"🚶",href:"/explore?q=산책길",hint:"짧고 편한 코스를 찾아보세요.",tone:"green"},
 {label:"한옥·도심",icon:"🏯",href:"/explore?q=도심",hint:"도심 테마 코스를 발견해보세요.",tone:"earth"},
 {label:"아트 포인트",icon:"📍",href:"/explore?type=art",hint:"GPS 아트와 테마런으로 이동해요.",tone:"orange"}
];
...
export default function InteractiveRunBoard(){
 ...
 return <section className="interactiveBoardWrap" aria-label="TTWITTUN 인터랙티브 러닝 보드">
  <div className="boardToolbar"><div><span className="eyebrow">TTWITTUN BOARD</span><h2>오늘의 러닝을 보드에서 바로 고르세요</h2></div><div className="boardToolbarActions"><button className="boardDiceButton" type="button" onClick={roll} disabled={rolling}>{rolling?"굴리는 중…":dice?`🎲 ${dice} · 다시 굴리기`:"🎲 주사위 굴리기"}</button><Link className="boardExploreLink" href="/explore">전체 코스 →</Link></div></div>
