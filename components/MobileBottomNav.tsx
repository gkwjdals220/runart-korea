...
type IconName="home"|"search"|"play"|"crew"|"profile";
function NavIcon({name,active}:{name:IconName;active:boolean}){
 ...
 if(name==="play")return <svg {...common} viewBox="0 0 28 28" fill="currentColor" stroke="none"><path d="M9 6.7c0-1.12 1.22-1.82 2.2-1.25l11.05 6.45a1.45 1.45 0 0 1 0 2.5L11.2 20.85A1.45 1.45 0 0 1 9 19.6V6.7Z"/></svg>;
...
const items=[
 ...
 {href:"/run/free",label:"RUN",icon:"play" as IconName,primary:true,match:(p:string)=>p.startsWith("/run/")},
