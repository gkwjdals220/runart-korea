...
export default async function ExplorePage(){
 ...
 return <main className="wrap explorePage standaloneExplorePage">
  <header className="top simpleTop"><Brand/><div className="nav"><Link className="btn ghost" href="/"><TtwittunButtonIcon name="back" compact/>홈</Link><Link className="btn" href="/run/free"><TtwittunButtonIcon name="run" compact/>RUN</Link></div></header>
  <section className="explorePageHero"><div><span className="eyebrow">COURSE EXPLORE</span><h1>오늘 달릴 코스 찾기</h1><p className="muted">검색 · 지도 · 필터 · 출발 준비를 이 페이지에서 끝내세요.</p></div><Link className="btn" href="/run/free"><TtwittunButtonIcon name="run"/>코스 없이 바로 RUN</Link></section>
