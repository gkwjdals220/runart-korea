...
export default function PrivacyPage(){
 return <main className="wrap hubPage legalPage">
  ...
  <section className="legalCard">
   ...
   <h2>3. 위치 정보</h2><p>위치 정보는 사용자가 러닝 기록 또는 주변 코스·시설 기능을 직접 사용하는 경우에만 요청합니다. iOS 앱에서 사용자가 러닝을 직접 시작한 경우에는 화면이 잠기거나 다른 앱으로 전환되어도 거리와 경로를 계속 측정하기 위해 백그라운드 위치 정보를 사용할 수 있습니다. 러닝을 종료하면 백그라운드 위치 측정도 종료되며, 진행 중인 거리·시간·페이스는 잠금화면 또는 Dynamic Island에 표시될 수 있습니다.</p>
