...
export default async function CoursePage({params}:{params:Promise<{id:string}>}){
 ...
 return <main className="wrap detailPage ttwittunDetailPage courseDetailPage">
   ...
   <div className="mobilePrimaryBar"><Link className="btn ghost" href={`/explore?course=${id}`}><TtwittunButtonIcon name="map" compact/>지도</Link><Link className="btn" href={`/run/${id}`}><TtwittunButtonIcon name="run" compact/>RUN 시작</Link></div>
 </main>
}
