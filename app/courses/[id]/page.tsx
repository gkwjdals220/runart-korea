...
export default async function CoursePage({params}:{params:Promise<{id:string}>}){
 ...
 return <main className="wrap detailPage ttwittunDetailPage courseDetailPage">
   <header className="top detailTop"><Brand/><div className="nav"><Link className="btn ghost" href="/explore">← 코스 탐색</Link><Link className="btn ghost" href="/favorites">♡ 내 찜</Link></div></header>
   ...
   <div className="mobilePrimaryBar"><Link className="btn ghost" href={`/explore?course=${id}`}>🗺️ 지도</Link><Link className="btn" href={`/run/${id}`}>🏃 RUN 시작</Link></div>
 </main>
}
