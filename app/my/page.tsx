...
export default async function MyPage(){
 ...
 return <main className="wrap hubPage myHubPage">
  ...
  <section className="pageHubGrid">
   ...
   <Link className="hubTile" href="/races/my"><span>🏁</span><div><small>MY RACE</small><h2>내 대회 일정</h2><p>저장한 대회 {raceCount||0}개 · 참가 상태</p></div><b>›</b></Link>
   <Link className="hubTile" href="/races"><span>⌕</span><div><small>RACE FINDER</small><h2>대회 찾기</h2><p>전국 일정·Google Form 접수</p></div><b>›</b></Link>
   <Link className="hubTile" href="/dashboard"><span>◉</span><div><small>CREW</small><h2>크루</h2><p>활동·출석·대회 관리</p></div><b>›</b></Link>
   <Link className="hubTile" href="/my/profile"><span>⚙</span><div><small>PROFILE</small><h2>프로필</h2><p>표시 이름 관리</p></div><b>›</b></Link>
   <Link className="hubTile" href="/my/account"><span>⌁</span><div><small>ACCOUNT</small><h2>계정 관리</h2><p>개인정보·계정 삭제 요청</p></div><b>›</b></Link>
  ...
  <div className="pageBottomActions"><Link className="btn ghost" href="/privacy">개인정보 처리방침</Link><Link className="btn ghost" href="/support">고객지원</Link></div>
 </main>;
}
