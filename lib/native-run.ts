...
export type NativeRunSnapshot = { available: boolean; running: boolean; paused: boolean; distanceM: number; elapsed: number; paceSecPerKm?: number; accuracy?: number; point?: NativeRunPoint; track?: NativeRunPoint[] };
